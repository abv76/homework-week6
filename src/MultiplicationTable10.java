...
// Test Data: Input a number: 8  ((any input int will show 10 x multiplications ))
...
public class MultiplicationTable10 {
        ...
        MultiplicationTable10.table();
    }
        static void table() {  //Static method with user input for table
